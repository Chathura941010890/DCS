...
public class PasswordReset extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oldPW = (EditText)findViewById(R.id.etOld);
        newPW = (EditText)findViewById(R.id.etNew);
        confPW = (EditText)findViewById(R.id.etConf);
        ...
        Check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AsyncCheck().execute(opw,CurrentUN,CurrentPW);
            }
        });
        ...
        Reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (npw.equals(cpw)) {
                    new AsyncReset().execute(CurrentUN , npw , cpw);
                }
                else{
                    Toast.makeText(PasswordReset.this , "Entered passwords are not matched." , Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private class AsyncCheck extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... params) {
            try {
                url = new URL("http://10.0.2.2/PassCheckUser.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equalsIgnoreCase("Passwords_Matched"))
            {
                ...
                Toast.makeText(PasswordReset.this , "Passwords matched. Now you can enter and reset your password." , Toast.LENGTH_LONG).show();


            }
            else if (result.equalsIgnoreCase("Passwords_Not_Matched")){

                Toast.makeText(PasswordReset.this, "Enter your correct old password", Toast.LENGTH_LONG).show();
    ...
    private class AsyncReset extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                url = new URL("http://10.0.2.2/PassResetUser.php");
        ...
        protected void onPostExecute(String result) {
            ...
            {
                Toast.makeText(PasswordReset.this , "Your password was reset. So you have to login again with new password." , Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(PasswordReset.this, "Your password was not reset.", Toast.LENGTH_LONG).show();
